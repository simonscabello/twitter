...
it('should be able to create tweet', function () {
...
todo('should make sure that only authenticated users can create tweets');
todo('body is required');
todo('the tweet should have a max length of 140 characters');
todo('should show the tweet in the timeline');
